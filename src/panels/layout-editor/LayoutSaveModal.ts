export interface LayoutSaveModalOptions {
  getName: () => string;
  onSave: (name: string) => void;
}

export class LayoutSaveModal {
  private readonly backdrop: HTMLDivElement;
  private readonly input: HTMLInputElement;
  private readonly status: HTMLParagraphElement;
  private readonly getName: LayoutSaveModalOptions["getName"];
  private readonly onSave: LayoutSaveModalOptions["onSave"];
  private readonly onKeyDown: (event: KeyboardEvent) => void;
  private open = false;

  constructor(options: LayoutSaveModalOptions) {
    ...
    this.input.placeholder = "Layout name";
  ...
  private submit(): void {
    ...
    if (!name) {
      this.status.textContent = "Enter a name to save this layout.";
      return;
    }
